          ...
          {stats.map((stat, idx) => (
            <motion.div
              ...
              transition={{
                ...
                y: { type: "spring", stiffness: 320, damping: 24, delay: idx * 0.1 },
              }}
              className="rounded-2xl bg-white border border-white shadow-md hover:shadow-xl transition-shadow duration-300"
            >

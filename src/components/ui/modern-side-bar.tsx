  ...
  switch (role) {
    case 'admin':
      return [
        ...
        { id: "calendar", name: "School Calendar", icon: CalendarDays, href: "/lms/admin/calendar" },
    ...
    case 'teacher':
      return [
        ...
        { id: "school-calendar", name: "School Calendar", icon: Calendar, href: "/lms/teacher/calendar" },
